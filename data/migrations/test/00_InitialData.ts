...
export async function down(params: any): Promise<void> {
    const db = params.context.server.mongo.db;
    await db.collection('ClassificationCategory').drop();
    await db.collection('ClassificationCategory').drop();
    await db.collection('ProductCategory').drop();
    await db.collection('ProductCategory').drop();
    await db.collection('Catalog').drop();
    await db.collection('CatalogSync').drop();
    await db.collection('ProductStage').drop();
    await db.collection('ProductStage').drop();

    await db.collection('AuditLog').drop();
    await db.collection('PricesOnline').drop();
    await db.collection('PricesStage').drop();
    await db.collection('ProductOnline').drop();
